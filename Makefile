...
ARCH		?= $(SUBARCH)
ifeq ($(ARCH),arm64)
CROSS_COMPILE	?= $(srctree)/../bin/prebuilts/gcc/linux-x86/aarch64/gcc-linaro-6.3.1-2017.05-x86_64_aarch64-linux-gnu/bin/aarch64-linux-gnu-
endif

ifeq ($(ARCH),arm)
CROSS_COMPILE	?= $(srctree)/../bin/prebuilts/gcc-linaro-6.3.1-2017.05-x86_64_arm-linux-gnueabihf/bin/arm-linux-gnueabihf-
endif
